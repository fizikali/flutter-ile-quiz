...
class _MyTestModePageState extends State<MyTestModePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(child: Scaffold(
      ...
      leading: GestureDetector(onTap: () => showCloseExamDialog(),child:
                      ...
                      new AlertDialog(
                        ...
                        content: Container(
                          ...
                          child: GridView.count(
                            ...
                            children: context.read(userListAnswer).state.asMap().entries.map((e){
                              return GestureDetector(
                                child: Padding(
                                  padding: const EdgeInsets.all(8),
                                  child: AutoSizeText(
                                    'Hayır ${e.key+1}:${e.value.answered == null || e.value.answered.isEmpty ? '': e.value.answered}',
                                    style: TextStyle(
                                      fontWeight: (e.value.answered != null && e.value.answered.isEmpty)
  ...
  void showCloseExamDialog() {
    showDialog(
        ...
        new AlertDialog(
          title: Text('Bitir'),
          content: Text('Testi bitirmek istiyor musunuz?'),
          actions: [
            TextButton(onPressed: (){
              Navigator.of(context).pop();//Close dialog
              Navigator.pop(context);//Close screen
